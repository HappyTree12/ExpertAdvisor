...
// Calculate MA7 values for the last 2 candles
   double EMA_SecondCandle =iMA(Symbol(), 0, EMA_Period, 0, MODE_EMA, PRICE_CLOSE, 2); // Second  MA7
   double EMA_Current = iMA(Symbol(), 0, EMA_Period, 0, MODE_EMA, PRICE_CLOSE, 1); // First  MA7
